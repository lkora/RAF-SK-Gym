...
public class EmailActivationConsumer {
    ...
    public EmailActivationConsumer(MailLogRepository mailLogRepository, JavaMailSender mailSender) {this.mailLogRepository = mailLogRepository;
	...
	public void consume(String message) throws JsonProcessingException {
		...
		mailMessage.setTo(activationEmailDto.receiver().email());
		mailMessage.setSubject("Account Activation");
		mailMessage.setText("Dear " + activationEmailDto.receiver().firstName() + " " + activationEmailDto.receiver().lastName() + ",\n\n"
		...
		// Log the email
		mailLogRepository.save(new EmailLog(topicName, activationEmailDto.receiver().email(), mailMessage.getSubject() + " --- " + mailMessage.getText()));
	}
}
